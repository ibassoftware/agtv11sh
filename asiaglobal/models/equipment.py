...
class AsiaGlobalEquipmentHistory(models.Model):
    ...
    picture_dispatched = fields.Many2many(comodel_name="ir.attachment",
                                          relation="m2m_ir_picture_dispatched_rel",
                                          column1="m2m_id",
                                          column2="attachment_id",
                                          string="Picture Dispatched")

    picture_returned = fields.Many2many(comodel_name="ir.attachment",
                                        relation="m2m_ir_picture_returned_rel",
                                        column1="m2m_id",
                                        column2="attachment_id",
                                        string="Picture Returned")

    documents = fields.Many2many(comodel_name="ir.attachment",
